const seasonsItems = [
  {
    ...
    episodes: [
      ...
      {
        number: "08",
        title: "Chapter Eight: The Flea and the Acrobat",
        description:
          "Hopper breaks into the lab while Nancy and Jonathan confront the force that took Will. The boys ask Mr. Clarke how to travel to another dimension.",
        duration: "53 min",
        video: {
      ...
      {
        number: "09",
        title: "Chapter Nine : The Vanishing of Will Byers",
        description:
          "On his way from a friend’s house, young Will sees something terrifying . Nearby, a sinister secret lurks in the depths of a government lab.",
        duration: "49 min",
        video: {
  ...
  },
  {
    ...
    episodes: [
      ...
      {
        number: "07",
        title: "Chapter Seven: The Flea and the Acrobat",
        description:
          "Hopper breaks into the lab while Nancy and Jonathan confront the force that took Will. The boys ask Mr. Clarke how to travel to another dimension.",
        duration: "53 min",
        video: {
